...
const members: TeamMember[] = [
  ...
  { img: "resource/guegueligue-christian.png", name: "Guegueligue Christian", role: { fr: "Développeur WordPress senior", en: "Senior WordPress Developer" }, objectPosition: "50% 14%" },
